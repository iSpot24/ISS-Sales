...
if (isset($messageCache)) { $message = $messageCache; }
                           ...
                           value="<?php echo e(Route::input('product.name')); ?>" required autocomplete="name" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                           ...
                           value="<?php echo e(Route::input('product.price')); ?>" required autocomplete="price" autofocus>
...
if (isset($messageCache)) { $message = $messageCache; }
                           ...
                           value="<?php echo e(Route::input('product.stock')); ?>" required autocomplete="stock" autofocus>
        ...
        <form method="post" action="/product/<?php echo e(Route::input('product.id')); ?>" enctype="multipart/form-data">
            ...
            <div class="deleteButton">
                <button type="submit" class="btn btn-danger"
                        onclick="return confirm('Are you sure you want to delete this Product?')">Delete Product
                </button>
                <a class="btn float-right btn-outline-primary" href="<?php echo e(route('home')); ?>"> Back </a>
            </div>
        </form>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/sales/resources/views/productUpdate.blade.php ENDPATH**/ ?>